...
public:
  Orgnization(string n, string m) : name(n), man(m) {}
  virtual void show() {}
};
...
protected:
public:
  College(string n, string m) : Orgnization(n, m) {}
  void show() {
    cout << "Dean of " << name << " is " << man << endl;
  }
};
...
protected:
public:
  Department(string n, string m) : Orgnization(n, m) {}
  void show() {
    cout << "Director of " << name << " is " << man << endl;
  }
};
int main() {
