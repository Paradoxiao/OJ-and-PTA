...
public:
  ...
  void show() {
    cout << name << " " << (int)weight << "kg, is citrus fruit." << endl;
  }
  virtual ~Citrus() {}
};
...
public:
  ...
  void show() {
    cout << name << " " << (int)weight << "kg, is mandarin." << endl;
  }
};
...
public:
  ...
  void show() {
    cout << name << " " << (int)weight << "kg, is pomelo." << endl;
  }
};
...
public:
  ...
  void show() {
    cout << name << " " << (int)weight << "kg, is citron." << endl;
  }
};
...
private:
public:
  Orange(string n, double w) : Citrus(n, w), Mandarin(n, w), Pomelo(n, w) {}
  void show() {
    cout << name << " " << (int)weight << "kg, is orange." << endl;
  }
};
...
public:
  ...
  void show() {
    cout << name << " " << (int)weight << "kg, is lime." << endl;
  }
};
...
private:
public:
  Tangerine(string n, double w) : Citrus(n, w), Mandarin(n, w), Pomelo(n, w), Orange(n, w) {}
  void show() {
    cout << name << " " << (int)weight << "kg, is tangerine." << endl;
  }
};
...
private:
public:
  Grapefruit(string n, double w) : Citrus(n, w), Mandarin(n, w), Pomelo(n, w), Orange(n, w) {}
  void show() {
    cout << name << " " << (int)weight << "kg, is grapefruit." << endl;
  }
};

class Lemon : public Orange, public Lime {
private:
public:
  Lemon(string n, double w) : Citrus(n, w), Mandarin(n, w), Pomelo(n, w), Citron(n, w), Orange(n, w), Lime(n, w) {}
  void show() {
    cout << name << " " << (int)weight << "kg, is lemon." << endl;
  }
};
int main() {
  Citrus *c;
